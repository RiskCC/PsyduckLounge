    ...
    internal class ModulesModule : IModule
    {
        ...
        void IModule.Install(ModuleManager manager)
        {
            ...
            manager.CreateCommands("modules", group =>
            {
                ...
                group.CreateCommand("enableowl")
                     .Description("Enables a modules for owls server.")
                     .PublicOnly()
                     .Do(e =>
                     {
                         string[] modules = { "StarlightStage", "Border", "N_des", "Gif", "Random" };
                         foreach (string x in modules)
                         {
                             ...
                             e.Channel.SendMessage($"Module {module.Id} was enabled for server {server.Name}.");
                         }
                     });
